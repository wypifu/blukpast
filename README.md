...
## [Tutorials](https://github.com/wypifu/blukpast/tree/master/tutorial/)

Each tutorial builds on the previous one. Run from the `build/` directory.

| # | Name | What it demonstrates |
|---|------|----------------------|
| 00 | [Hello World](https://github.com/wypifu/blukpast/tree/master/tutorial/00_hello_world) | Swap chain, minimal graphics pipeline, push constants — the classic triangle |
| 01 | [Playground](https://github.com/wypifu/blukpast/tree/master/tutorial/01_payground) | All built-in geometry types, PBR materials, GLTF loading, free camera |
| 02 | [Camera](https://github.com/wypifu/blukpast/tree/master/tutorial/02_camera) | Free camera (WASD + mouse drag), sky box, dynamic viewport/scissor |
| 03 | [PBR / IBL](https://github.com/wypifu/blukpast/tree/master/tutorial/03_pbr_ibl) | Physically-based rendering with image-based lighting — irradiance map, pre-filtered environment, GGX BRDF LUT |
| 04 | [Font & Input](https://github.com/wypifu/blukpast/tree/master/tutorial/04_font_input) | HUD overlay, TTF font rendering, keyboard and mouse input callbacks |
| 05 | [Shadow Map](https://github.com/wypifu/blukpast/tree/master/tutorial/05_shadow_map) | Offline 4096×4096 depth pre-pass, PCF shadow sampling in the scene shader |
| 06 | [Floor Reflection](https://github.com/wypifu/blukpast/tree/master/tutorial/06_floor_reflection) | Off-screen reflection pass, reflected view matrix, floor blending |
| 07 | [Animations](https://github.com/wypifu/blukpast/tree/master/tutorial/07_animations) | Click-to-spin with ray-sphere picking, per-object spin state, dynamic shadow updates |
| 08 | [Deformation](https://github.com/wypifu/blukpast/tree/master/tutorial/08_deformation) | CPU-side spring-damper vertex deformation — drag to dent, release to shake |
| 09 | [Destruction](https://github.com/wypifu/blukpast/tree/master/tutorial/09_destruction) | Compute shader particle system — click past the speed threshold to explode an object, watch it respawn after 5 s |
